...
function condation(vlu) {
	if (vlu == "hi" || vlu == "asc") {
		setTimeout(function() {
			messageBar.appendChild(createTextYou("wcs...", curentTime()));
			audioTon.play();
		}, 1500);
	} else if (vlu == "Seetahay " || vlu == "seetahay" || vlu == "seetahay" || vlu == "ila hadal") {
		setTimeout(function() {
			messageBar.appendChild(createTextYou("Waan fiicnahay xabibi...", curentTime()));
			audioTon.play();
		}, 1500);
	} else if (vlu == "Xagee aaday" || vlu == "xagee aaday" || vlu == "ila hadal") {
		setTimeout(function() {
			messageBar.appendChild(createTextYou("waan joogaa", curentTime()));
			audioTon.play();
		}, 1500);
	} else if (vlu == "Sawirkaaga isoodir" || vlu == "sawirkaaga isoodir" || vlu == "sawirkaaga isoodir" || vlu == "ila hadal" || vlu == "send image" || vlu == "send your images" || vlu == "send your photo") {
		setTimeout(function() {
	...
	} else if (vlu == "Muuqaal soodir" || vlu == "muuqaal soodir" || vlu == "video" || vlu == "send video") {
		setTimeout(function() {
			let video = "video/1.mp4";
			messageBar.appendChild(createVideoYou(video, curentTime()));
			audioTon.play();
		}, 1500);
	} else if (vlu == "Kuma maqlo" || vlu == "kuma maqlo" || vlu == "ila hadal" || vlu == "send audio") {
		setTimeout(function() {
			let audio = "audio/ton.mp3";
			messageBar.appendChild(createAudioYou(audio, curentTime()));
			audioTon.play();
		}, 1500);
	} else if (vlu == "Waad ku mahadsantahy" || vlu == "waad ku mahadsantahy" || vlu == "mahadsanid" || vlu == "mahadsanid") {
		setTimeout(function() {
			messageBar.appendChild(createTextYou("Adaa mudan...", curentTime()));
			audioTon.play();
		}, 1500);
	}
	 else if (vlu == "Magacaa"|| vlu == "magacaa" || vlu == "ahmed miyaa" || vlu == "ahmed miyaa" || vlu == "Your Name Plz" || vlu == "your name plz") {
		setTimeout(function() {
			let name = "Magacayga waa abdallah " + nameStore;
